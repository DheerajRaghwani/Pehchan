...
async function searchRation() {
	...
	if (!bc || !aadhaarLast4) {
		box.innerHTML =
			"<p class='muted'>Please enter Birth Certificate and last 4 digits of Aadhaar.</p>";
		return;
	}
		...
		box.innerHTML = `
            <table class="full-width-table">
                ...
                <tr>
                    ...
                    <th>Ration Card</th><td>${
											data.rationCardNumber ?? "Not Updated"
										}</td>
                </tr>
...
function resetSearchRation() {
	...
	document.getElementById("rationRecordBox").innerHTML =
