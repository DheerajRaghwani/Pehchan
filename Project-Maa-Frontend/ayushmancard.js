...
async function searchAyushman() {
	...
	if (!bc || !aadhaarLast4 || !rationNumber) {
		box.innerHTML =
			"<p class='muted'>Please enter Birth Certificate, last 4 digits of Aadhaar, and Ration Card.</p>";
		return;
	}
		...
		box.innerHTML = `
            <table class="full-width-table">
                ...
                <tr>
                    ...
                    <th>Ayushman Card</th><td>${
											data.ayushmanCardNumber ?? "Not Updated"
										}</td>
                </tr>
...
function resetSearchAyushman() {
	...
	document.getElementById("ayushmanRecordBox").innerHTML =
