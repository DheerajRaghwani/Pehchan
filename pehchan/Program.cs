...
builder.Services.AddScoped<IChildrecord, ChildrecordService>();
 
builder.Services.AddScoped<IUserLogin, UserLoginService>();
builder.Services.AddScoped<IMotherschemerecord, MotherschemerecordService>();
